...
const optionVariants: Variants = {
  initial: { opacity: 0, scale: 0.8, filter: "blur(5px)", z: 0 },
  animate: {
    opacity: 1,
    scale: 1,
    filter: "blur(0px)",
...
export default function Quiz() {
  ...
  // ... (Thank You screen or Progress Bar would go here if they existed)
                  ...
                  {selectedOption === index && (
                    ...
                    >
                      <motion.path
                        ...
                        strokeWidth={3}
                        d="M5 13l4 4L19 7" // This is your desired checkmark path
                      />
                    </motion.svg>
                  )}
                </div>
